...
public class DatabaseHelper extends SQLiteOpenHelper {
	...
	/**
	 * This method returns the database schema that has been passed into this object.
	 * 
	 * This returned schema is not necessarily a representation of actual database schema. It
	 * is just the object that has been passed into this objects constructor.
	 *
	 */
	...
	private void populateInitialDatamapTable(SQLiteDatabase db, int oldVersion) {
		...
		while(!cursor.isAfterLast()){
			...
			DatabaseTable table = parseCreateStatment(createStatement);
		...
		if(!schema.getTables().isEmpty()){
			try{
				...
				DatabaseUpdater.populateDatamapTables(myConnection, schema);
			} catch (DatabaseException e) {
	 ...
	 * @return
	 */
	private DatabaseTable parseCreateStatment(String createStatement) {
		...
		DatabaseTable table = new SQLiteTable(tableName);
