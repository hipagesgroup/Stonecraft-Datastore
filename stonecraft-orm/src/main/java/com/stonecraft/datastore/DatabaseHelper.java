...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    protected DatabaseHelper(Context context,
            AndroidDBConnection connection, DbSchemaModel schema,
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        try {
            ...
            if (myConnectionCreatedListener != null) {
                myConnectionCreatedListener.onUpgrade(
                        Datastore.getDataStore(myDBSchema.getName()));
            }
    ...
    public void onOpen(SQLiteDatabase db) {
        ...
        try {
            ...
            if (myConnectionCreatedListener != null) {
                myConnectionCreatedListener.onOpen(
                        Datastore.getDataStore(myDBSchema.getName()));
            }
        } catch (DatabaseException e) {
    ...
    public synchronized void close() {
        if (myConnectionCreatedListener != null) {
            myConnectionCreatedListener.onClose();
        }
        super.close();
    }
    ...
    private void populateInitialDatamapTable(SQLiteDatabase db, int oldVersion) {
        Cursor cursor = db.query(
                ...
                new String[]{AndroidDBConnection.COL_SQL}, "type = 'table'", null, null, null,
                null);
        cursor.moveToFirst();
